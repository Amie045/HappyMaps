...
class AddHappyMapActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var mHappyMapsDetails: HappyMapsModel? = null
    ...
    companion object{
        ...
        private const val IMAGE_DIRECTORY = "HappyMapsImages"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mHappyMapsDetails = intent.getParcelableExtra(MainActivity.EXTRA_PLACE_DETAILS)
        ...
        mHappyMapsDetails.let {
            if (it != null){
                savedImageToInternalStorage = Uri.parse(mHappyMapsDetails!!.image)
                iv_place_image.setImageURI(savedImageToInternalStorage)
        ...
        when(p0!!.id){
            ...
            R.id.btn_save -> {
                when {
                    ...
                    val happyPlaceModel = HappyMapsModel(
                        if(mHappyMapsDetails == null) 0 else mHappyMapsDetails!!.id,
                    ...
                    if (mHappyMapsDetails == null) {
                        val addHappyPlace = dbHandler.addHappyMap(happyPlaceModel)
                        if (addHappyPlace > 0) {
                            setResult(Activity.RESULT_OK)
                        }
                        finish()
                    }else {
                        val updateHappyPlace = dbHandler.updateHappyMap(happyPlaceModel)
                        ...
                        .withPermissions(
                            ...
                            override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                                if (report!!.areAllPermissionsGranted()) {
                                    Toast.makeText(this@AddHappyMapActivity,
            ...
            if (requestCode == GALLERY){
                if (data != null){
                    ...
                    try {
                        ...
                        Log.e("Save Image: ", "path :: $savedImageToInternalStorage")
                        iv_place_image.setImageBitmap(selectedImageBitmap)
                    } catch (e: IOException) {
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyMapActivity, "Failed to Load Image from", Toast.LENGTH_LONG).show()
                    }
                }
                ...
                Log.e("Save Images", "path :: $savedImageToInternalStorage")
