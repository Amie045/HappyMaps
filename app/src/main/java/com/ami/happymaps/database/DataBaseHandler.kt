package com.ami.happymaps.database
...
class DataBaseHandler(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val TABLE_HAPPY_PLACE = "HappyMapsTable"
    ...
    fun addHappyMap(happyPlace: HappyMapsModel): Long {
    ...
    fun updateHappyMap(happyPlace: HappyMapsModel): Int {
        val db = this.writableDatabase
    ...
    fun deleteHappyMap(happyPlace: HappyMapsModel) : Int {
        val db = this.writableDatabase
    ...
    fun getHappyMapList(): ArrayList<HappyMapsModel> {
        val happyPlaceList = ArrayList<HappyMapsModel>()
